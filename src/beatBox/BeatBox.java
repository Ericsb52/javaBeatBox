...
public class BeatBox {
	...
	public void buildGUI() {
		...
		stop.addActionListener(new MyStopListerner());
		buttonBox.add(stop);
		...
		JButton restorIt = new JButton("restor it");
		downTempo.addActionListener(new MyReadInListener());
		buttonBox.add(restorIt );
	...
	public class MyStopListerner implements ActionListener {
		public void actionPerformed(ActionEvent a) {
			sequencer.stop();
		}
	}
